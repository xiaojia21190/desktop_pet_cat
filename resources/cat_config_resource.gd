...
static func create_default() -> CatConfigResource:
	...
	var default_animations: Array[Dictionary] = [
		{"name": "idle_stand", "row": 0, "frames": 8, "speed": 5.0, "loop": true},
		{"name": "idle_active", "row": 1, "frames": 8, "speed": 7.0, "loop": true},
		{"name": "idle_sit", "row": 1, "frames": 8, "speed": 5.0, "loop": true},
		{"name": "idle_lie", "row": 2, "frames": 8, "speed": 4.0, "loop": true},
		{"name": "sleep_curl", "row": 3, "frames": 8, "speed": 3.0, "loop": true},
		{"name": "stretch", "row": 4, "frames": 8, "speed": 6.0, "loop": false},
		{"name": "yawn", "row": 5, "frames": 8, "speed": 6.0, "loop": false},
		{"name": "walk", "row": 0, "frames": 8, "speed": 8.0, "loop": true},
		{"name": "trot", "row": 1, "frames": 8, "speed": 9.0, "loop": true},
		{"name": "run", "row": 2, "frames": 8, "speed": 11.0, "loop": true},
		{"name": "jump", "row": 3, "frames": 8, "speed": 8.0, "loop": false},
		{"name": "land", "row": 4, "frames": 8, "speed": 8.0, "loop": false},
		{"name": "retreat", "row": 5, "frames": 8, "speed": 8.0, "loop": false},
		{"name": "watch_focus", "row": 0, "frames": 8, "speed": 6.0, "loop": true},
		{"name": "pounce_ready", "row": 1, "frames": 8, "speed": 8.0, "loop": true},
		{"name": "pounce_attack", "row": 2, "frames": 8, "speed": 10.0, "loop": false},
		{"name": "dodge", "row": 3, "frames": 8, "speed": 10.0, "loop": false},
		{"name": "startled", "row": 4, "frames": 8, "speed": 8.0, "loop": false},
		{"name": "lick_groom", "row": 5, "frames": 8, "speed": 7.0, "loop": true},
		{"name": "tail_wag", "row": 1, "frames": 8, "speed": 8.0, "loop": true},
		{"name": "typing_attack", "row": 2, "frames": 8, "speed": 10.0, "loop": true},
		{"name": "blocking", "row": 3, "frames": 8, "speed": 8.0, "loop": true},
		{"name": "chasing", "row": 0, "frames": 8, "speed": 10.0, "loop": true},
		{"name": "rolling", "row": 4, "frames": 8, "speed": 9.0, "loop": false},
		{"name": "eat", "row": 2, "frames": 8, "speed": 7.0, "loop": true},
		{"name": "carry", "row": 2, "frames": 8, "speed": 7.0, "loop": true},
		{"name": "greet", "row": 1, "frames": 8, "speed": 8.0, "loop": false},
		{"name": "celebrate", "row": 4, "frames": 8, "speed": 9.0, "loop": false},
		{"name": "comfort", "row": 5, "frames": 8, "speed": 6.0, "loop": false},
		{"name": "break_hint", "row": 5, "frames": 8, "speed": 6.0, "loop": false},
		{"name": "head_pat_happy", "row": 1, "frames": 8, "speed": 8.0, "loop": false},
		{"name": "head_pat_dodge", "row": 3, "frames": 8, "speed": 9.0, "loop": false},
		{"name": "angry", "row": 4, "frames": 8, "speed": 8.0, "loop": false},
		{"name": "daze", "row": 5, "frames": 8, "speed": 4.0, "loop": true},
		{"name": "watch", "row": 0, "frames": 8, "speed": 6.0, "loop": true},
		{"name": "pounce", "row": 2, "frames": 8, "speed": 10.0, "loop": false},
		{"name": "sleep", "row": 3, "frames": 8, "speed": 3.0, "loop": true},
		{"name": "sneak_eat", "row": 2, "frames": 8, "speed": 7.0, "loop": false},
		{"name": "lick", "row": 5, "frames": 8, "speed": 7.0, "loop": false},
		{"name": "happy", "row": 4, "frames": 8, "speed": 9.0, "loop": false},
		{"name": "peek", "row": 0, "frames": 8, "speed": 6.0, "loop": true},
		{"name": "walk_away", "row": 5, "frames": 8, "speed": 8.0, "loop": false},
		{"name": "ignore", "row": 5, "frames": 8, "speed": 4.0, "loop": true},
		{"name": "kneading", "row": 1, "frames": 8, "speed": 6.0, "loop": true}
	]
